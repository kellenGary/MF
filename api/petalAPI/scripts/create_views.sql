...
CREATE OR REPLACE VIEW "ListeningHistoryEnriched" AS
SELECT 
    lh."Id",
    lh."UserId",
    lh."PlayedAt",
...
CREATE OR REPLACE VIEW "TrackDetailsWithArtists" AS
SELECT 
    t."Id" as "TrackId",
    t."SpotifyId" as "TrackSpotifyId",
    t."Name" as "TrackName",
...
CREATE OR REPLACE VIEW "UserRecentlyPlayedEnriched" AS
SELECT 
    lh."UserId",
    lh."PlayedAt",
    t."Id" as "TrackId",
...
CREATE OR REPLACE VIEW "UserProfileData" AS
SELECT 
    u."Id" as "UserId",
    u."DisplayName",
    u."Handle",
...
CREATE OR REPLACE VIEW "UserLikedTracksEnriched" AS
SELECT 
    ult."UserId",
    ult."LikedAt",
    t."Id" as "TrackId",
...
CREATE OR REPLACE VIEW "UserPlaylistsEnriched" AS
SELECT 
    up."UserId",
    up."Relation",
    up."FollowedAt",
